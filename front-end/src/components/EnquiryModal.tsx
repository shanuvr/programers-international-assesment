      ...
      <div className="bg-surface-container-lowest w-full max-w-lg rounded-xl shadow-md border border-outline-variant overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 bg-surface-container-low border-b border-outline-variant flex-shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-h3 text-h3 text-primary leading-tight">
                {product.title}
              </h4>
        ...
        >
          ...
          <div className="p-6 space-y-4 overflow-y-auto">
            ...
            <div>
              ...
              <input
                className="w-full bg-surface-container-lowest border border-outline-variant rounded-lg px-4 py-2 font-body-sm text-body-sm focus:border-secondary focus:ring-1 focus:ring-secondary outline-none transition-all"
                id="fullName"
                name="fullName"
            ...
            <div>
              ...
              <textarea
                className="w-full bg-surface-container-lowest border border-outline-variant rounded-lg px-4 py-2 font-body-sm text-body-sm focus:border-secondary focus:ring-1 focus:ring-secondary outline-none transition-all resize-none"
                id="address"
                name="address"
            ...
            <div>
              <label className="flex items-center gap-2 cursor-pointer group">
                ...
                <span className="font-body-sm text-body-sm text-on-surface-variant group-hover:text-on-surface transition-colors">
                  Request a technical demo with this enquiry
                </span>
              </label>
            </div>
